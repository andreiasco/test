...
<section class="home-story" id="despre-noi">
    ...
    <div class="home-timeline" aria-label="Drumul proiectului">
        ...
        <div><span>📣</span><strong>discuții</strong></div><i>→</i>
        <div><span>🔬</span><strong>încercări</strong></div><i>→</i>
...
<section class="home-explainer" aria-label="Ce este pe site">
    ...
    <article class="home-note"><span class="home-note-icon">📖</span><div><h3>Am adăugat</h3><p>fișe de lectură, personaje, valori morale și semnificații.</p></div></article>
...
<section class="home-values" id="how-to">
    ...
    <div class="home-values-grid">
        ...
        <div><span>🔐</span><p>Poate fi serioasă fără să fie rigidă.</p></div>
